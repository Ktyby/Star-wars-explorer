						...
						<div className="modal__characteristic">
							<div className="modal__stats">
								...
								<p className="modal__description">
									Manufacturer: <span>{starshipsTilesData.manufacturer}</span>
								</p>
								<p className="modal__description">
									Cost: <span>{starshipsTilesData.cost_in_credits}</span>
								</p>
								<p className="modal__description">
									Length: <span>{starshipsTilesData.length}</span>
								</p>
								<p className="modal__description">
									Max speed: <span>{starshipsTilesData.max_atmosphering_speed}</span>
								</p>
								<p className="modal__description">
									Crew: <span>{starshipsTilesData.crew}</span>
								</p>
								<p className="modal__description">
									Passengers: <span>{starshipsTilesData.passengers}</span>
								</p>
								<p className="modal__description">
									Cargo capacity: <span>{starshipsTilesData.cargo_capacity}</span>
								</p>
								<p className="modal__description">
									Consumables: <span>{starshipsTilesData.consumables}</span>
								</p>
								<p className="modal__description">
									Hyperdrive rating: <span>{starshipsTilesData.hyperdrive_rating}</span>
								</p>
								<p className="modal__description">
									MGLT: <span>{starshipsTilesData.MGLT}</span>
								</p>
								<p className="modal__description">
									Starship class: <span>{starshipsTilesData.starship_class}</span>
								</p>
							</div>
						</div>
...
ModalStarships.propTypes = {
	...
	starshipsTilesData: PropTypes.object,
